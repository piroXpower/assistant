...
@Sammy.on(events.NewMessage(pattern=r"^[?!]purge"))
@is_admin
...
@Sammy.on(events.NewMessage(pattern="^[!?/]spurge"))
@is_admin
...
@Sammy.on(events.NewMessage(pattern="^[!?/]del$"))
@is_admin
...
@Sammy.on(events.callbackquery.CallbackQuery(data="purges"))
async def _(event):
